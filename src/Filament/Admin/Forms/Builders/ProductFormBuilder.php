...
namespace App\Filament\Admin\Forms\Builders;

use App\Filament\Admin\Forms\Components\RadioCard;
use App\Filament\Admin\Forms\Components\SelectCard;
use App\Filament\Admin\Forms\Components\TieredPricing;
                ...
                Action::make('fill_with_flat_factory_data')
                    ...
                    ->action(function (Set $set) {
                        ...
                        if (app()->environment(['local', 'dusk'])) {
                            $testProduct = Product::factory()->make()->toArray();
